...
namespace DCL.ABConverter
{
    ...
    public static class WearablesCollectionClient
    {
        ...
        public static WearableCollectionsAPIData.Collection[] EnsureWearableCollections()
        {
            ...
            UnityWebRequest w = UnityWebRequest.Get(GetCollectionsFetchURL());
            w.SendWebRequest();
            ...
            {
                log.Error($"Request error! Wearable collections at '{GetCollectionsFetchURL()}' couldn't be fetched! -- {w.error}");
                return null;
            }
        ...
        {
            return GetWearablesFetchURL() + "collectionId=" + targetCollectionId;
        }
        ...
        private static void DumpWearableQueue(ABConverter.Core core, Queue<WearableItem> items, System.Action<GltfImport> OnWearableLoad, Action<Core.ErrorCodes> OnConversionFinish = null, bool cleanAndExitOnFinish = true)
        {
        ...
        private static void GLTFImporter_OnNonBodyWearableLoad(GltfImport obj)
        {
            /*obj.importSkeleton = false;
            obj.maxTextureSize = 512;#1#
            // TODO
        }

        private static void GLTFImporter_OnBodyWearableLoad(GltfImport obj)
        {
