...
namespace DCL
{
    public interface IAssetDatabase
    {
        ...
        void BuildMetadata(IFile envFile, string finalDownloadedPath, Dictionary<string,string> bundleNameToHash, Dictionary<string,string> lowerCaseHashes, IAssetBundleManifest manifest, string version);
