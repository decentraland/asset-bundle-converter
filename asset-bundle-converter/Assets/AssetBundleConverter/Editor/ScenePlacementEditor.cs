...
namespace DCL.ABConverter.Editor
{
    public class ScenePlacementEditor : EditorWindow
    {
        ...
        private bool onlyPlaceVisibleEntities = true;
        private Vector2 scrollPosition;
        private string lastResult = "";
        private List<string> availableManifests = new List<string>();
        private int selectedManifestIndex = 0;

        [MenuItem("Decentraland/Place Scene Assets")]
        public static void ShowWindow()
        {
            var window = GetWindow<ScenePlacementEditor>("Scene Placement");
        ...
        private void OnGUI()
        {
            ...
            onlyPlaceVisibleEntities = EditorGUILayout.Toggle("Only Place Visible Entities", onlyPlaceVisibleEntities);
        ...
        private void PlaceSceneAssets()
        {
            ...
            string entityMappingPath = $"Assets/_SceneManifest/{sceneId}.json";
            ...
            if (!File.Exists(entityMappingPath))
            {
                string message = $"Entity mapping file not found at: {entityMappingPath}";
                EditorUtility.DisplayDialog("Error", message, "OK");
                lastResult = message;
                return;
            }
            ...
            try
            {
                ...
                // Load the EntityMappingsDTO from JSON
                string entityMappingJson = File.ReadAllText(entityMappingPath);
